class GameController {
    ...
    showFakeTower(e) {
        ...
        this.fackTower.style.backgroundSize = 'contain'; // L'image s'adapte à la taille sans déformation
        this.fackTower.style.backgroundPosition = 'center'; // Centre l'image
        this.fackTower.style.backgroundRepeat = 'no-repeat'; // Évite la répétition de l'image
        this.fackTower.style.opacity = '0.5'; // Ajoute 50% de transparence
        ...
        this.FackRange.style.left = `${pixelX + this.game.gameMap.cellSize / 2 - this.game.gameAth.selectedTowerData.range}px`;
        this.FackRange.style.top = `${pixelY + this.game.gameMap.cellSize / 2 - this.game.gameAth.selectedTowerData.range}px`;
        // this.FackRange.style.display = 'none';
