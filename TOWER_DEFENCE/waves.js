class Waves {
    ...
    nextWave() {
        ...
        this.startWaveButton.style.backgroundImage = "url('assets/boutons/papierDechirer.png')";
    ...
    waveIsAnd() {
        if (this.queueEnnemis.length == 0 && this.waveNumber > 0) {
            this.startWaveButton.style.backgroundImage = "url('assets/boutons/papierDechirerRed.png')";
        }
    }
